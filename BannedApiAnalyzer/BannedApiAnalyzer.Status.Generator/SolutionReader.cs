...
namespace BannedApiAnalyzer.Status.Generator
{
    using System;
    ...
    /// <summary>
    /// A class that is used to parse the BannedApiAnalyzer solution to get an overview
    ...
    public class SolutionReader
    {
        ...
        private async Task InitializeAsync()
        {
            ...
            _noCodeFixAttributeTypeSymbol = _analyzerCompilation.GetTypeByMetadataName("BannedApiAnalyzer.NoCodeFixAttribute");
            _diagnosticAnalyzerTypeSymbol = _analyzerCompilation.GetTypeByMetadataName(typeof(DiagnosticAnalyzer).FullName);

            _batchFixerType = _codeFixAssembly.GetType("BannedApiAnalyzer.Helpers.CustomBatchFixAllProvider");
